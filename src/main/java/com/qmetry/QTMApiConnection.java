...
public class QTMApiConnection {
    ...
    public boolean uploadFileToTestSuite(String filePath, String testSuiteId, String testSuiteName, String automationFramework, String automationHierarchy, String buildName, String platformName, String project, String release, String cycle,
	    String testCaseFields, String testSuiteFields, String tsFolderPath, String tcFolderPath, String skipWarning, String isMatchingRequired) throws InvalidCredentialsException, ProtocolException, IOException, QTMException {
	...
	try {
	    ...
	    if (isMatchingRequired != null && !isMatchingRequired.isEmpty())
			builder.addTextBody("isMatchingRequired", isMatchingRequired, ContentType.TEXT_PLAIN);
